...
export interface ApiAllSiteAllSite extends Struct.CollectionTypeSchema {
...
export interface ApiBisonCasinoHomePageBisonCasinoHomePage
  extends Struct.CollectionTypeSchema {
  collectionName: 'bison_casino_home_pages';
  info: {
    singularName: 'bison-casino-home-page';
    pluralName: 'bison-casino-home-pages';
    displayName: 'BisonCasino_HomePage';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    pageImg: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    pageBg: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::bison-casino-home-page.bison-casino-home-page'
    > &
      Schema.Attribute.Private;
  };
}

export interface ApiEditorInfoEditorInfo extends Struct.CollectionTypeSchema {
  collectionName: 'editor_infos';
  info: {
  ...
  attributes: {
    editorInfo: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'default';
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String & Schema.Attribute.Private;
    faqRow: Schema.Attribute.Component<'table.table-row', true>;
    pretitle: Schema.Attribute.String;
    title: Schema.Attribute.String;
...
export interface ApiInfoCasinoInfoCasino extends Struct.CollectionTypeSchema {
  collectionName: 'info_casinos';
  info: {
    singularName: 'info-casino';
    pluralName: 'info-casinos';
    displayName: 'InfoCasino';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    tableInfoCasino: Schema.Attribute.Component<'table.table-row', true>;
...
export interface ApiSecurityAndLicenseSecurityAndLicense
  extends Struct.CollectionTypeSchema {
  collectionName: 'security_and_licenses';
  info: {
    singularName: 'security-and-license';
    pluralName: 'security-and-licenses';
    displayName: 'SecurityAndLicense';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::security-and-license.security-and-license'
    > &
      Schema.Attribute.Private;
  };
}

export interface ApiSeoMetaTagSeoMetaTag extends Struct.CollectionTypeSchema {
  collectionName: 'seo_meta_tags';
  info: {
    singularName: 'seo-meta-tag';
    pluralName: 'seo-meta-tags';
    displayName: 'SeoMetaTag';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::all-site.all-site': ApiAllSiteAllSite;
      'api::bison-casino-home-page.bison-casino-home-page': ApiBisonCasinoHomePageBisonCasinoHomePage;
      'api::editor-info.editor-info': ApiEditorInfoEditorInfo;
